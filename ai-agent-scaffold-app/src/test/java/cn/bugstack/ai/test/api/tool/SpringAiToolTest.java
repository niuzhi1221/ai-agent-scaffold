...
public class SpringAiToolTest {
    ...
    public static void main(String[] args) {
        OpenAiApi openAiApi = OpenAiApi.builder()
                ...
                .apiKey("sk-YL0QWjcJ0PdxYiGTBbEa3e5aBdFe4d7f8e51E4210fCb3550")
    ...
    public static McpSyncClient sseMcpClient() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com/v2/ai_search/mcp/")
                .sseEndpoint("sse?api_key=bce-v3/ALTAK-Ipf9T7jAtOqTY9mQsNIsc/795060a693d12b5b445f0c94eddf0990fcda8fa9")
                .build();
